...
# /home/zhangSongbo/miniconda3/envs/py312env/bin/python get_stock_price_info.py -m cn -s 2026-03-10 > ./logs/get_cn_stock_price_info.log
...
# crontab -e
# 30 15 * * * sh /path/to/your/run.sh # 每天15:30 执行脚本
...
# python VnpyBacktesting/back_test.py --symbols sh603938 --start-date 2026-02-01 --end-date 2026-03-16 --buy-date 2026-03-04
