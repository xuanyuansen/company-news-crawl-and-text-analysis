...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--market", help="which market", required=True, choices=["cn", "hk", "us", "uszh"])
    parser.add_argument("-s", "--start_date", help="set start date")
    parser.add_argument("-j", "--joint_quant", help="weather to init quant", default=False)
    ...
    if "cn" == market_type:
        ...
        stock_info_spyder.get_historical_hk_stock_daily_price(start_date=_start_date,
